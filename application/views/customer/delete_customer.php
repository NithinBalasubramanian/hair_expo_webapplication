...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
  <h1 class="h3 mb-0 text-gray-800">Dashboard / Delete Customer </h1>
  ...
  <a href="<?php echo base_url();?>View/customer/list_customer" class=" d-sm-inline-block btn btn-sm btn-grad btn-primary shadow-sm"><i class="fas fa-add"></i>List Customer</a>
 </div>
...
<div class="col-xl-12 col-lg-7">
  <div class="card shadow mb-4">
    ...
    <div class="card-header py-3 d-flex flex-row align-items-center row">
      <h6 class="col-md-6 m-0 font-weight-bold text-primary">List Deleted Customer Table</h6>
    ...
    <table id="dataTable" class="table table-bordered table-striped table-hover">
                ...
                <tbody>
                <?php $customer = $this->Admin_model->table_column($tablename='customer','status','0');
				if(count($customer) >0) {
          $i=1;
