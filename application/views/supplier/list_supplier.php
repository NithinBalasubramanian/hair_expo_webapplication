...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
  ...
  <a href="<?php echo base_url();?>View/supplier/delete_supplier" class=" d-sm-inline-block btn btn-sm btn-grad btn-warning shadow-sm"><i class="fas fa-add"></i> Deleted supplier</a>
 </div>
...
<div class="col-xl-12 col-lg-7">
  <div class="card shadow mb-4">
    ...
    <table id="dataTable" class="table table-bordered table-striped table-hover">
                ...
                <tbody>
                <?php $customer = $this->Admin_model->table_column($tablename='supplier','status','1');
				if(count($customer) >0) {
          $i=1;
