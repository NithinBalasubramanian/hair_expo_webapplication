...
<?php $this->load->view('front/include/header_menu'); ?>
   ...
   <section class="welcome-area">
        <div class="welcome-slides owl-carousel">
            ...
            <div class="single-welcome-slide bg-img" style="background-image: url(<?php echo base_url(); ?>assets/front/img/bg-img/16.jpg);">
                <!-- Welcome Content -->
            ...
            <div class="row align-items-center">
                ...
                <div class="col-12 col-md-6 col-lg-4">
                    <div class="about-us-thumbnail mb-80">
                        <img src="<?php echo base_url(); ?>assets/front/img/bg-img/15.jpg" alt="">
                    </div>
                </div>
            ...
            <div class="row">
                ...
                <div class="col-12 col-sm-6 col-lg-3">
                    <div class="single-service-area mb-80 wow fadeInUp" data-wow-delay="200ms">
                        <img src="<?php echo base_url(); ?>assets/front/img/core-img/s1.png" alt="">
                        <h5>Coloring</h5>
                ...
                <div class="col-12 col-sm-6 col-lg-3">
                    <div class="single-service-area mb-80 wow fadeInUp" data-wow-delay="400ms">
                        <img src="<?php echo base_url(); ?>assets/front/img/core-img/s3.png" alt="">
                        <h5>Haircut</h5>
                ...
                <div class="col-12 col-sm-6 col-lg-3">
                    <div class="single-service-area mb-80 wow fadeInUp" data-wow-delay="600ms">
                        <img src="<?php echo base_url(); ?>assets/front/img/core-img/s4.png" alt="">
                        <h5>Hairstyle</h5>
            ...
            <div class="row align-items-center">
                <div class="col-12 col-lg-6">
                    <div class="choose-us-thumbnail mt-30 mb-80">
                        <div class="choose-us-img bg-img" style="background-image: url(<?php echo base_url(); ?>assets/front/img/bg-img/4.jpg);"></div>
                    </div>
                </div>
                <div class="col-12 col-lg-6">
                    <!-- Section Heading -->
                    <div class="section-heading">
                        <h2>Why Choose Us</h2>
                        <p>We are the best in the Hair and Beauty Industury with highly trained professional in Visakahapatnam (A.P)</p>
                    </div>
                    <!-- Choose Us Content -->
            ...
            <div class="row akame-portfolio-area">
                ...
                <div class="col-12 col-sm-6 col-lg-3 akame-portfolio-item haircuts mb-30 wow fadeInUp" data-wow-delay="200ms">
                    <div class="akame-portfolio-single-item">
                        <img src="<?php echo base_url(); ?>assets/front/img/bg-img/5.jpg" alt="">
                        ...
                        <!-- Thumbnail Zoom -->
                        <a href="<?php echo base_url(); ?>assets/front/img/bg-img/5.jpg" class="thumbnail-zoom"><i class="icon_search"></i></a>
                    </div>
                </div>
                ...
                <div class="col-12 col-sm-6 akame-portfolio-item dye mb-30 wow fadeInUp" data-wow-delay="300ms">
                    <div class="akame-portfolio-single-item">
                        <img src="<?php echo base_url(); ?>assets/front/img/bg-img/6.jpg" alt="">
                        ...
                        <!-- Thumbnail Zoom -->
                        <a href="<?php echo base_url(); ?>assets/front/img/bg-img/6.jpg" class="thumbnail-zoom"><i class="icon_search"></i></a>
                    </div>
                </div>
                ...
                <div class="col-12 col-lg-3 akame-portfolio-item shave mb-30 wow fadeInUp" data-wow-delay="400ms">
                    <div class="akame-portfolio-single-item">
                        <img src="<?php echo base_url(); ?>assets/front/img/bg-img/7.jpg" alt="">
                        ...
                        <!-- Thumbnail Zoom -->
                        <a href="<?php echo base_url(); ?>assets/front/img/bg-img/7.jpg" class="thumbnail-zoom"><i class="icon_search"></i></a>
                    </div>
                </div>
                ...
                <div class="col-12 col-sm-6 col-lg-3 akame-portfolio-item hairstyle mb-30 wow fadeInUp" data-wow-delay="500ms">
                    <div class="akame-portfolio-single-item">
                        <img src="<?php echo base_url(); ?>assets/front/img/bg-img/8.jpg" alt="">
                        ...
                        <!-- Thumbnail Zoom -->
                        <a href="<?php echo base_url(); ?>assets/front/img/bg-img/8.jpg" class="thumbnail-zoom"><i class="icon_search"></i></a>
                    </div>
                </div>
                ...
                <div class="col-12 col-sm-6 col-lg-3 akame-portfolio-item dye mb-30 wow fadeInUp" data-wow-delay="600ms">
                    <div class="akame-portfolio-single-item">
                        <img src="<?php echo base_url(); ?>assets/front/img/bg-img/9.jpg" alt="">
                        ...
                        <!-- Thumbnail Zoom -->
                        <a href="<?php echo base_url(); ?>assets/front/img/bg-img/9.jpg" class="thumbnail-zoom"><i class="icon_search"></i></a>
                    </div>
                </div>
            </div>
    ...
    <section class="akame-our-expert-area section-padding-80-0">
        ...
        <!-- Side Thumbnail -->
        <div class="side-thumbnail" style="background-image: url(<?php echo base_url(); ?>assets/front/img/bg-img/14.png);"></div>
            ...
            <div class="row justify-content-end">
                <div class="col-12 col-lg-6">
                    ...
                    <div class="our-certificate-area mb-60 d-flex align-items-center">
                        <img src="<?php echo base_url(); ?>assets/front/img/core-img/certificate-1.png" alt="">
                        <img src="<?php echo base_url(); ?>assets/front/img/core-img/certificate-2.png" alt="">
                        <img src="<?php echo base_url(); ?>assets/front/img/core-img/certificate-3.png" alt="">
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-12 col-sm-6 col-lg-3">
                    <div class="single-team-member mb-80 wow fadeInUp" data-wow-delay="200ms">
                        <div class="team-member-img">
                            <img src="<?php echo base_url(); ?>assets/front/img/bg-img/10.jpg" alt="">
                            <!-- Social Info -->
                ...
                <div class="col-12 col-sm-6 col-lg-3">
                    <div class="single-team-member mb-80 wow fadeInUp" data-wow-delay="400ms">
                        <div class="team-member-img">
                            <img src="<?php echo base_url(); ?>assets/front/img/bg-img/11.jpg" alt="">
                            <!-- Social Info -->
                            <div class="team-social-info d-flex align-items-center justify-content-center">
                                <div class="social-link">
                                    <a href="#"><i class="fa fa-facebook"></i></a>
                ...
                <div class="col-12 col-sm-6 col-lg-3">
                    <div class="single-team-member mb-80 wow fadeInUp" data-wow-delay="600ms">
                        <div class="team-member-img">
                            <img src="<?php echo base_url(); ?>assets/front/img/bg-img/12.jpg" alt="">
                            <!-- Social Info -->
                            <div class="team-social-info d-flex align-items-center justify-content-center">
                                <div class="social-link">
                                    <a href="https://www.facebook.com/Hair-Expo-101277751732805"><i class="fa fa-facebook"></i></a>
                                    <a href="#"><i class="fa fa-twitter"></i></a>
                                    <a href="#"><i class="fa fa-linkedin"></i></a>
                                    <a href="#"><i class="fa fa-dribbble"></i></a>
                                </div>
                ...
                <div class="col-12 col-sm-6 col-lg-3">
                    <div class="single-team-member mb-80 wow fadeInUp" data-wow-delay="800ms">
                        <div class="team-member-img">
                            <img src="<?php echo base_url(); ?>assets/front/img/bg-img/13.jpg" alt="">
                            <!-- Social Info -->
                            <div class="team-social-info d-flex align-items-center justify-content-center">
                                <div class="social-link">
                                    <a href="#"><i class="fa fa-facebook"></i></a>
    ...
    <section class="akame-cta-area bg-gray section-padding-80">
        ...
        <!-- CTA Thumbnail -->
        <div class="cta-thumbnail bg-img" style="background-image: url(<?php echo base_url(); ?>assets/front/img/bg-img/cta.png);"></div>
    </section>
