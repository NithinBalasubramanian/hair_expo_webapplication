...
<div class="col-xl-12 col-lg-12">
  <div class="card shadow mb-4">
    ...
    <div id="page_pdf" style="width:100%;height:auto;">
         <div class="bill" style="width:100%;height:auto;">
            ...
            <div class="img1 row" style="width:100%;height:160px;margin-left:0px;">
                ...
                <div class="col-md-12 text-center"> <h5 style="margin-top:10px;font-size:18px;"><b>INVOICE</b></h5></div>
            ...
            <div class="container" style="padding-top:10px;padding-bottom:10px;">
             <?php $invoice = $this->Admin_model->table_column('purchase','purchase_invoice_no',$edit_id);
                    ...
                    <div class="col-md-12 text-center" style="margin-top:65px;font-size:12px;">
   ...
   <div class="container" style="padding-top:20px;margin-top: -45px;">
