    ...
    <div id="page_pdf" style="width:100%;height:auto;">
         <div class="bill" style="width:100%;height:100%;">
            ...
            <?php $invoice = $this->Admin_model->table_column('invoice','invoice_no',$edit_id);
                    ...
                    ?>
                    <div class="row">
                    <div class="col-md-7 text-left"><p style="margin-bottom:0px;margin-top:20px;">To,</p>
                    ...
                    Phone No:<?php echo strtoupper($cus_row['contact']); ?><br>
                    <?php if($cus_row['email'] != ''){ ?>
                    Email Id:<?php echo $cus_row['email']; ?><br>
                    <?php } ?>
                    <?php } ?>
                    </p></div>
                    <div class="col-md-5 text-left">
                        <P>Invoice No :<?php echo $row['invoice_no']; ?> <br>
                    Invoice Date :<?php echo $row['date_created']; ?><br><br>
                    ServicePerson :<br>1030 SIVAKUMAR K </P></div>
                </div>
                </div>
            </div>
...
<?php    if(count($invoice) > 0)
    ...
    <p style="font-size: 16px;"> <?php
                            ...
                            ?></p>
    <div class="row">
        <div class="col-md-2" style="font-size: 16px;text-align:center;">Remarks :</div><div class="col-md-10"></div><br>
